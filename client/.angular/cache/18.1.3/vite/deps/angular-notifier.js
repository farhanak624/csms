...
// node_modules/angular-notifier/fesm2022/angular-notifier.mjs
var _c0 = (a0) => ({
  notification: a0
});
...
_NotifierQueueService.ɵfac = function NotifierQueueService_Factory(ɵt) {
  return new (ɵt || _NotifierQueueService)();
};
...
_NotifierService.ɵfac = function NotifierService_Factory(ɵt) {
  return new (ɵt || _NotifierService)(ɵɵinject(NotifierQueueService), ɵɵinject(NotifierConfigToken));
};
...
_NotifierTimerService.ɵfac = function NotifierTimerService_Factory(ɵt) {
  return new (ɵt || _NotifierTimerService)();
};
...
_NotifierAnimationService.ɵfac = function NotifierAnimationService_Factory(ɵt) {
  return new (ɵt || _NotifierAnimationService)();
};
...
_NotifierNotificationComponent.ɵfac = function NotifierNotificationComponent_Factory(ɵt) {
  return new (ɵt || _NotifierNotificationComponent)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(NotifierService), ɵɵdirectiveInject(NotifierTimerService), ɵɵdirectiveInject(NotifierAnimationService));
};
...
_NotifierContainerComponent.ɵfac = function NotifierContainerComponent_Factory(ɵt) {
  return new (ɵt || _NotifierContainerComponent)(ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(NotifierQueueService), ɵɵdirectiveInject(NotifierService));
};
...
_NotifierModule.ɵfac = function NotifierModule_Factory(ɵt) {
  return new (ɵt || _NotifierModule)();
};
